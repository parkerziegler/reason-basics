...
console.log(Pervasives.string_of_int(result));
...
var FactorialArgument = Caml_exceptions.create("Demo-ReasonBasics.FactorialArgument");
...
console.log(Pervasives.string_of_int(factorialOdd(5)));

console.log(Pervasives.string_of_int(45000));
...
for(var num = 1; num <= 10; ++num){
  if (num < 5) {
    console.log($$Array.append(store, /* int array */[num]));
  } else if (num >= 5) {
    console.log($$Array.append(store, /* int array */[(num << 1)]));
  } else {
    console.log(store);
  }
}

for(var num$1 = 10; num$1 >= 1; --num$1){
  if (num$1 < 5 || num$1 >= 10) {
    $$Array.fill(store, 0, 1, num$1);
  } else {
    console.log(store);
  }
}
